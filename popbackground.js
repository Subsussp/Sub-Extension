...
// const seasonI = document.getElementById('number');
// seasonI.addEventListener('input',(e)=>{
...
//             // `https://www.subtitlecat.com/subs/208/${encodeURIComponent(show.name)}%20-%201x01%20-%20${encodeURIComponent(show.name)}.en.html`
